...
function UserDashboard() {
    ...
    useEffect(async () => {
        try {
            let dashboard = await axios.get("https://plans-new.herokuapp.com/userdashboard", {
                headers: {
    ...
    let fetchTheaters = async () => {
        try {
            let allEvent = await axios.get("https://plans-new.herokuapp.com/event")
                ...
                <div id="content-wrapper" className="d-flex flex-column userdata"  >
                    <div id="content">
                        ...
                        <div className="d-sm-flex justify-content-between mb-3 sticky-top" style={{ background: "black", padding: "20px" }}>
                            <h1 className="h3 mb-0" style={{ color: "white" }}>All Plans</h1>
                                                ...
                                                return <div className="col-lg-4 col-md-6  mb-4">
                                                    ...
                                                    <div className="card  text-center" style={{ color: "black" }} id="cardhover" >
                                                        ...
                                                        <div className="card-body fw-bold " >
                                                            ...
                                                            <h5 className='fs-6 fw-bold' >End date : {event.date} : 12.00pm</h5>
                                                            <h5 className='text-primary fs-6 fw-bold'>type : Prepiad </h5>                                                   
