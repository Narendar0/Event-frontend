                ...
                <div id="content-wrapper" className="d-flex flex-column ">
                    <div id="content">
                        ...
                        <div className="d-sm-flex align-items-center justify-content-between mb-4 mt-3">
                            <h1 className="h3 mb-0 text-gray text-dark ml-3">All Plans</h1>

                            <Link to={"/add-event"} className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-4 px-3">Add Plan</Link>
                        </div>
